...
public class MyProgram {
    public static void main(String[] args) {
        ...
        Book Book1 = new Book(73836280, "1984", Author1.FirstName + Author1.LastName, Publisher1.PublisherName, "15:10:2014", true);
        Book Book2 = new Book(65467784, "Pride and Prejudice", Author2.FirstName + Author2.LastName, Publisher2.PublisherName, "10:04:2004", false);
        Book Book3 = new Book(74676252, "The Hunger Games", Author3.FirstName + Author3.LastName, Publisher3.PublisherName, "05:11:2016", false);
        Book Book4 = new Book(85445572, "The Adventures of Sherlock Holmes", Author4.FirstName + Author4.LastName, Publisher4.PublisherName, "19:05:1995", true);
        Book Book5 = new Book(11144477, "To Kill a Mockingbird", Author5.FirstName + Author5.LastName, Publisher5.PublisherName, "01:02:1956", true);

        Book[] books = {Book1, Book2, Book3, Book4, Book5};

        Arrays.sort(books, Comparator.comparing(Book::getAuthors));
        for (Book book : books) {
